// WEBDL site-config — favoyeurtube.net (voyeur tube, best-guess)
window.WEBDL_SITES = window.WEBDL_SITES || {};
window.WEBDL_SITES['favoyeurtube.net'] = {
  label: 'favoyeurtube',
  platform: 'favoyeurtube',
  ...
  itemTypes: [
    {
      ...
      endpoint: '/download',
      buildBody: (url, channel) => ({ url, platform: 'favoyeurtube', channel, title: '' }),
