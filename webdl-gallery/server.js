...
const THUMB_CONCURRENCY = Math.max(1, Number(process.env.WEBDL_GALLERY_THUMB_CONCURRENCY || 3));
const THUMB_WARM_INTERVAL_MS = Math.max(1000, Number(process.env.WEBDL_GALLERY_THUMB_WARM_INTERVAL_MS || 2500));
const THUMB_WARM_BATCH = Math.max(1, Number(process.env.WEBDL_GALLERY_THUMB_WARM_BATCH || 40));
